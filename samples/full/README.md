...
This section show you a sample config file for building microservice based on various external service. This sample must be used with sxapi-core engine (dev) 
