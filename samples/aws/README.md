...
This section show you some sample config file for building microservices based on AWS services. Theses samples must be used with sxapi-core engine (master) 
