# sxapi AWS SQS Sample

This section show you a sample config file for building microservice based on AWS SQS service. This sample must be used with sxapi-core engine (v0.0.8) 
...
1. [addMessage](https://github.com/startxfr/sxapi-core/blob/v0.0.8/docs/resources/sqs.md#addmessage-endpoint)
