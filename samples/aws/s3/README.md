...
This section show you a sample config file for building microservice based on AWS S3 service. This sample must be used with sxapi-core engine (dev) 
...
1. [addMessage](https://github.com/startxfr/sxapi-core/blob/dev/docs/resources/s3.md#addmessage-endpoint)
