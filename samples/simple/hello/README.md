...
This section show you a sample config file for building microservice with a simple static response. This sample must be used with sxapi-core engine (v0.0.17) 
