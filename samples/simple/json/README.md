...
This section show you a sample config file for building microservice with a static JSON response. This sample must be used with sxapi-core engine (dev) 
...
RUNNING THIS SAMPLE
===================
run ```sxapi-cli setup simple/json```
