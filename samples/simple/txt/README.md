# sxapi Simple text Sample

This section show you a sample config file for building microservice with a simple text response. This sample must be used with sxapi-core engine (v0.0.17) 
...
3. Create a sub-directory for hosting your microservice (```mkdir simple-txt; cd simple-txt```) 
4. Setup this sample in your directory ```sxapi-cli setup simple/txt```
