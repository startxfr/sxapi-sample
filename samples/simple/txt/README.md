...
This section show you a sample config file for building microservice with a simple text response. This sample must be used with sxapi-core engine (master) 
