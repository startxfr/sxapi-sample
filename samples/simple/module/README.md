# sxapi Dynamic response Sample

This section show you a sample config file for building microservice with a dynamic response. This sample must be used with sxapi-core engine (v0.0.17) 
