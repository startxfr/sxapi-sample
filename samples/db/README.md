...
This section show you some sample config file for building microservices based on DB services. Theses samples must be used with sxapi-core engine (v0.0.8) 
