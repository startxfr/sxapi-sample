...
This section show you some sample config file for building microservices based on DB services. Theses samples must be used with sxapi-core engine (v0.0.17) 
...
SAMPLE LIST
===========
[1. how to create a microservice based on Couchbase DB service](couchbase/README.md)
[2. how to create a microservice based on Mysql DB service](mysql/README.md)
